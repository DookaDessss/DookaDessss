...
#### `📄 Are you searching for MCBE addons that can be used on realms or worlds? Look no further than Dooka-Packages, a collection of open-source MCBE packs and addons created by me.` { [Dooka-Packages](https://github.com/DookaDessss/Dooka-Packages) }
